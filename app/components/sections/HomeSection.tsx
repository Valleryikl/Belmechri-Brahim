import GlobalWave from "../backgrounds/GlobalWave"

export default function HomeSection() {
  return (
    <div>
      <GlobalWave />
      <section className="home-section bg-bottom home pt-[27vh] pl-[10%] relative z-[10]">
      ...
      <button className="backdrop-blur-[5px] border mt-[15px] ml-[15vw] px-[55px] py-[3px] text-[17px] font-semibold
                          hover:scale-[1.1] duration-300 ease-out hover:cursor-pointer"><a href="#works">My Works</a></button>
    </section>
    </div>
  )
}
